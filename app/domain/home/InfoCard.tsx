export default function InfoCard() {
  return (
    <div className="col-span-4 col-start-2 bg-background-homedetail rounded-lg p-3 gap-1">
      <div className="text-center text-2xl font-bold text-Text-subTitle">
        Pedicure Tine uw beste keuze voor pedicure aan huis in regio Duffel{" "}
        <br />
        Aangename voeten met onze behandelingen
      </div>

      <div className="text-justify">
        Al meer dan 20 jaar kan iedereen bij Tine Pauwels terecht voor een
        profesionele manicure of pedicure. Vandaag de dag is regelmatice
        voetverzorging geen luxe maar een noodzakelijkheid om allerlei pijnen en
        kwalen te voorkomen. Voeten die verzorg zijn, voelen niet alleen goed
        maar kunnen ook ander lichamelijke gebreken voorkomen
      </div>
