...
export function ContactCard() {
    ...
    return (
        ...
        <div className="w-full rounded-full">
          {/* <iframe width="100%" height="250" src="https://maps.google.com/maps?width=100%25&amp;height=250&amp;hl=en&amp;q=berthoutstraat14%20duffel%20beldium+(Pedicure%20Tine)&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe> */}
